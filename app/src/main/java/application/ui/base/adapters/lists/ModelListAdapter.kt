package application.ui.base.adapters.lists
...
abstract class ModelListAdapter<M: BaseModel, VH: ModelListAdapter<M, VH>.ViewHolder<M>> : RecyclerView.Adapter<VH>() {

    open fun areItemsTheSame(oldItem: M, newItem: M) = oldItem.id == newItem.id
    ...
    abstract inner class ViewHolder<M: BaseModel>(view: View) : RecyclerView.ViewHolder(view) {
